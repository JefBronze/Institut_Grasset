...
void menuAdm()
{
    ...
    cout << "Presse 3 pour Annuler une reservation\n";
    cout << "Presse 4 pour Chercher les reserves\n";
    cout << "-----------------------------------------------\n";
    cout << "Presse q pour quitter le logiciel a tout moment\n";
...
void annulerReserve() // arrumar!!
{
    system("cls");

    cout << "Pour annuler votre reservation, entrez votre numero de reservation: ";
    ...
    //----------------------Search - Chambre 1
    if (checkin_info == chambre1[4] || checkin_info == chambre2[4] || checkin_info == chambre3[4] || checkin_info == chambre4[4] || checkin_info == chambre5[4] || checkin_info == chambre6[4])
    {
        if (chambre1[4] == checkin_info)
        {
            chambre1.clear();
            cout << "Votre reservation a ete annulee avec succes.";
            this_thread::sleep_for(chrono::milliseconds(3000));
            menuclient();
        }
